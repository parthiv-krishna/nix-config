# ownCloud Infinite Scale (oCIS) - file storage
{ lib }:
lib.custom.mkSelfHostedFeature {
  ...
  serviceConfig =
    ...
    in
    {
      ...
      custom.features = {
        meta.unfree.allowedPackages = [
          "ocis_5-bin"
        ];

        # Authelia OIDC extra config for oCIS
        selfhosted.autheliaExtraConfig = {
        ...
        # Register OIDC clients for oCIS (web, desktop, android, ios)
        selfhosted.oidcClients = {
          "ocis" = {
